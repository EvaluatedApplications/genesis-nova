...
- **Codebase:** ~19k lines of source across ~100 files. Test suite: a fast behaviour suite (101 tests, ~2 s)
  plus opt-in long-running training/emergence tests (12, gated behind `RUN_SLOW=1`).
