...
- `README.md` is the engine spec. `CLAUDE.md` is the working agreement (substrate, golden training paths, memory rules).
- `PLATONIC_NUCLEUS.md` covers substrate capabilities (the dual-face data model).
- `claude/README.md` covers the applied tools in depth. `claude/SELF_IMPROVE.md` covers the compounding self-improvement loop.
