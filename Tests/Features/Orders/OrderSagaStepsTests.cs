...
using Xunit;
using TestMockInventoryService = EvalApp.Solid.Starter.Tests.Orders.Shared.MockInventoryService;
using TestMockPaymentService = EvalApp.Solid.Starter.Tests.Orders.Shared.MockPaymentService;
using TestMockShipmentService = EvalApp.Solid.Starter.Tests.Orders.Shared.MockShipmentService;
