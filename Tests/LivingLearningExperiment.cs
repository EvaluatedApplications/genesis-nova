...
public sealed class LivingLearningExperiment
{
    ...
    [SlowFact] // bare subjects ("alice is doctor") via the LEARNED role parser — needs a GRU-trained warm-up
    ...
    [SlowFact] // bare subjects ("qab is red") — The OTHER candidate obstacle, at SCALE: does the mind stay COHERENT (genesis G2 non-contradiction) when
