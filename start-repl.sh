#!/bin/bash
# Genesis Nova - Interactive Training UI Quick Start
...
cd "$(dirname "$0")/src/bin/Release/net8.0"

# Generate training examples if not present
if [ ! -f "examples-50.jsonl" ]; then
